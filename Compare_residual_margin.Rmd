...
ggplot(tmpsum) + geom_bar(aes(x=reorder(method,-count),y=count,fill=dependence),position="stack",stat="identity") + scale_fill_manual(values=c("1"="#070707","2"="#C11432","3"="#009ADA","4"="#66A64F","5"="#FDD10A")) + xlab("Method for residual margins")
