...
nllv <- c()
method_par <- data.frame("Normal" = c(as.numeric(tmp1giv2[1,7]),as.numeric(tmp1giv2[1,9]),as.numeric(tmp1giv2[1,9]),2,2),"GenGaus" = c(as.numeric(tmp1giv2[2,8]),as.numeric(tmp1giv2[2,10]),as.numeric(tmp1giv2[2,10]),as.numeric(tmp1giv2[2,13]),as.numeric(tmp1giv2[2,13])),"AGGdelta" = c(as.numeric(tmp1giv2[3,8]),as.numeric(tmp1giv2[3,10]),as.numeric(tmp1giv2[3,10]),as.numeric(tmp1giv2[3,14]),as.numeric(tmp1giv2[3,15])),"AGGsig" = c(as.numeric(tmp1giv2[4,8]),as.numeric(tmp1giv2[4,11]),as.numeric(tmp1giv2[4,12]),as.numeric(tmp1giv2[4,13]),as.numeric(tmp1giv2[4,13])),"AGG" = c(as.numeric(tmp1giv2[5,8]),as.numeric(tmp1giv2[5,11]),as.numeric(tmp1giv2[5,12]),as.numeric(tmp1giv2[5,14]),as.numeric(tmp1giv2[5,15])))
...
a <- as.numeric(tmp1giv2[1,5])
b <- as.numeric(tmp1giv2[1,6])
...
tmp %>% filter(given=="1") %>% group_by(method,res) %>% summarise(sum=sum(AIC)) %>% arrange(sum)
