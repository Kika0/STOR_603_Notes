...
tmp <- rbind(L1,L2,L2,L4,L5) %>% mutate(method=factor(method),given=factor(as.character(given)),res=factor(as.character(res)))
...
tmp <- rbind(tmp,rbind(L1,L2,L2,L4,L5) %>% mutate(method=factor(method),given=factor(as.character(given)),res=factor(as.character(res))))
