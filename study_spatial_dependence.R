...
tm_shape(temp_sf %>% dplyr::select(Temperature)) + tm_dots(col="Temperature",style="cont",palette="viridis")
tm_shape(temp_sf %>% dplyr::select(Temperature)) + tm_dots(col="Temperature",style="cont",size=0.05,palette="-RdYlBu",legend.col.reverse=TRUE)+
...
tm_shape(uk_temp_sf%>% dplyr::select(Temperature)) + tm_dots(col="Temperature",style="cont",size=0.3,palette="viridis")
