...
newite4 <- par_est_ite(df = sims, d1j = dij, v = v, given = cond_site, N = 10, show_ite = TRUE)

cond_site <- find_site_index(Lancaster)
dij <- as.numeric(st_distance(uk_sf_rot[cond_site,],uk_sf_rot[-cond_site,]))
newite5 <- par_est_ite(df = sims, d1j = dij, v = v, given = cond_site, N = 10, show_ite = TRUE)

cond_site <- find_site_index(Newcastle)
dij <- as.numeric(st_distance(uk_sf_rot[cond_site,],uk_sf_rot[-cond_site,]))
newite6 <- par_est_ite(df = sims, d1j = dij, v = v, given = cond_site, N = 10, show_ite = TRUE)
...
# 
# # save these objects for faster knitting
# save(uk,uk_temp_sf,tmp_est1,tmp_est2,tmp_est3,tmp_est1a,tmp_est2a,tmp_est3a,tmp_est4,tmp_est5,tmp_est6,tmp_est4a,tmp_est5a,tmp_est6a,newite1,newite2,newite3,newite4,newite5,newite6,file = "spatialobjects.RData")
