...
plot_map_param <- function(tmp_est1,tmp_est2,tmp_est3,method = "AGG") {
  cond_var <- 1
...
pa <- tmap_arrange(tm_shape(uk_tmp1) + tm_dots(col="a",style="cont",size=0.3,palette="viridis",title=TeX("$\\alpha$"), breaks=lims) + tm_layout(main.title="Birmingham"),
             tm_shape(uk_tmp2) + tm_dots(col="a",style="cont",size=0.3,palette="viridis",title=TeX("$\\alpha$"), breaks=lims) + tm_layout(main.title="Glasgow"),tm_shape(uk_tmp3) + tm_dots(col="a",style="cont",size=0.3,palette="viridis",title=TeX("$\\alpha$"), breaks=lims) + tm_layout(main.title="London"),ncol=3)
 if (method=="AGG") {
...
pb <- tmap_arrange(tm_shape(uk_tmp1) + tm_dots(col="b",style="cont",size=0.3,palette="viridis",title=TeX("$\\beta$"), breaks=lims) + tm_layout(main.title="Birmingham"),
             tm_shape(uk_tmp2) + tm_dots(col="b",style="cont",size=0.3,palette="viridis",title=TeX("$\\beta$"), breaks=lims) + tm_layout(main.title="Glasgow"),tm_shape(uk_tmp3) + tm_dots(col="b",style="cont",size=0.3,palette="viridis",title=TeX("$\\beta$"), breaks=lims) + tm_layout(main.title="London"),ncol=3)
}
...
pmu <- tmap_arrange(tm_shape(uk_tmp1) + tm_dots(col="mu",style="cont",size=0.3,palette="viridis",title=TeX("$\\mu$"), breaks=lims) + tm_layout(main.title="Birmingham"),
             tm_shape(uk_tmp2) + tm_dots(col="mu",style="cont",size=0.3,palette="viridis",title=TeX("$\\mu$"), breaks=lims) + tm_layout(main.title="Glasgow"),tm_shape(uk_tmp3) + tm_dots(col="mu",style="cont",size=0.3,palette="viridis",title=TeX("$\\mu$"), breaks=lims) + tm_layout(main.title="London"),ncol=3)

sigmax <- 3
lims <- seq(min(as.numeric(rbind(uk_tmp1,uk_tmp2,uk_tmp3)$sig),na.rm = TRUE),sigmax,length.out=6)
psig <- tmap_arrange(tm_shape(uk_tmp1) + tm_dots(col="sig",style="cont",size=0.3,palette="viridis",title=TeX("$\\sigma$"), breaks=lims) + tm_layout(main.title="Birmingham"),
             tm_shape(uk_tmp2) + tm_dots(col="sig",style="cont",size=0.3,palette="viridis",title=TeX("$\\sigma$"), breaks=lims) + tm_layout(main.title="Glasgow"),tm_shape(uk_tmp3) + tm_dots(col="sig",style="cont",size=0.3,palette="viridis",title=TeX("$\\sigma$"), breaks=lims) + tm_layout(main.title="London"),ncol=3)
if (method=="AGG") {
...
pmuagg <- tmap_arrange(tm_shape(uk_tmp1) + tm_dots(col="mu_agg",style="cont",size=0.3,palette="viridis",title=TeX("$\\mu_{AGG}$"), breaks=lims) + tm_layout(main.title="Birmingham"),
             tm_shape(uk_tmp2) + tm_dots(col="mu_agg",style="cont",size=0.3,palette="viridis",title=TeX("$\\mu_{AGG}$"), breaks=lims) + tm_layout(main.title="Glasgow"),tm_shape(uk_tmp3) + tm_dots(col="mu_agg",style="cont",size=0.3,palette="viridis",title=TeX("$\\mu_{AGG}$"), breaks=lims) + tm_layout(main.title="London"),ncol=3)

lims <- seq(min(as.numeric(rbind(uk_tmp1,uk_tmp2,uk_tmp3)$sigl),na.rm = TRUE),sigmax,length.out=6)
psigl <- tmap_arrange(tm_shape(uk_tmp1 %>% filter(sigl < sigmax)) + tm_dots(col="sigl",style="cont",size=0.3,palette="viridis",title=TeX("$\\sigma_l$"), breaks=lims) + tm_layout(main.title="Birmingham"),
             tm_shape(uk_tmp2 %>% filter(sigl < sigmax)) + tm_dots(col="sigl",style="cont",size=0.3,palette="viridis",title=TeX("$\\sigma_l$"), breaks=lims) + tm_layout(main.title="Glasgow"),tm_shape(uk_tmp3 %>% filter(sigl < sigmax)) + tm_dots(col="sigl",style="cont",size=0.3,palette="viridis",title=TeX("$\\sigma_l$"), breaks=lims) + tm_layout(main.title="London"),ncol=3)

lims <- seq(min(as.numeric(rbind(uk_tmp1,uk_tmp2,uk_tmp3)$sigu),na.rm = TRUE),sigmax,length.out=6)
psigu <- tmap_arrange(tm_shape(uk_tmp1 %>% filter(sigu < sigmax)) + tm_dots(col="sigu",style="cont",size=0.3,palette="viridis",title=TeX("$\\sigma_u$"), breaks=lims) + tm_layout(main.title="Birmingham"),
             tm_shape(uk_tmp2 %>% filter(sigu < sigmax)) + tm_dots(col="sigu",style="cont",size=0.3,palette="viridis",title=TeX("$\\sigma_u$"), breaks=lims) + tm_layout(main.title="Glasgow"),tm_shape(uk_tmp3 %>% filter(sigu < sigmax)) + tm_dots(col="sigu",style="cont",size=0.3,palette="viridis",title=TeX("$\\sigma_u$"), breaks=lims) + tm_layout(main.title="London"),ncol=3)
deltamax <- 5
...
pdeltal <- tmap_arrange(tm_shape(uk_tmp1 %>% filter(deltal < deltamax)) + tm_dots(col="deltal",style="cont",size=0.3,palette="viridis",title=TeX("$\\delta_l$"), breaks=lims) + tm_layout(main.title="Birmingham"),
             tm_shape(uk_tmp2 %>% filter(deltal < deltamax)) + tm_dots(col="deltal",style="cont",size=0.3,palette="viridis",title=TeX("$\\delta_l$"), breaks=lims) + tm_layout(main.title="Glasgow"),tm_shape(uk_tmp3 %>% filter(deltal < deltamax)) + tm_dots(col="deltal",style="cont",size=0.3,palette="viridis",title=TeX("$\\delta_l$"), breaks=lims) + tm_layout(main.title="London"),ncol=3)

lims <- seq(deltamin,deltamax,length.out=6)
pdeltau <- tmap_arrange(tm_shape(uk_tmp1 %>% filter(deltau < deltamax)) + tm_dots(col="deltau",style="cont",size=0.3,palette="viridis",title=TeX("$\\delta_u$"), breaks=lims) + tm_layout(main.title="Birmingham"),
             tm_shape(uk_tmp2 %>% filter(deltau < deltamax)) + tm_dots(col="deltau",style="cont",size=0.3,palette="viridis",title=TeX("$\\delta_u$"), breaks=lims) + tm_layout(main.title="Glasgow"),tm_shape(uk_tmp3 %>% filter(deltau < deltamax)) + tm_dots(col="deltau",style="cont",size=0.3,palette="viridis",title=TeX("$\\delta_u$"), breaks=lims) + tm_layout(main.title="London"),ncol=3)
...
```{r}
pick_site <- 100
df <- data.frame("a"=as.numeric(newite1[[1]][pick_site,]), "mu" = as.numeric(newite1[[2]][pick_site,]), "sig" = as.numeric(newite1[[3]][pick_site,]), "index" = 0:(ncol(newite[[1]])-1))
...
pick_site <- 100
df <- data.frame("a"=as.numeric(newite2[[1]][pick_site,]), "mu" = as.numeric(newite2[[2]][pick_site,]), "sig" = as.numeric(newite2[[3]][pick_site,]), "index" = 0:(ncol(newite[[1]])-1))
p1 <- ggplot(df) + geom_point(aes(x=index,y=a)) + ylab(TeX("$\\alpha$"))
p2 <- ggplot(df) + geom_point(aes(x=index,y=mu)) + ylab(TeX("$\\mu$"))
p3 <- ggplot(df) + geom_point(aes(x=index,y=sig)) + ylab(TeX("$\\sigma$"))
grid.arrange(p1,p2,p3,ncol=1)
...
pick_site <- 70
df <- data.frame("a"=as.numeric(newite3[[1]][pick_site,]), "mu" = as.numeric(newite3[[2]][pick_site,]), "sig" = as.numeric(newite3[[3]][pick_site,]), "index" = 0:(ncol(newite[[1]])-1))
p1 <- ggplot(df) + geom_point(aes(x=index,y=a)) + ylab(TeX("$\\alpha$"))
p2 <- ggplot(df) + geom_point(aes(x=index,y=mu)) + ylab(TeX("$\\mu$"))
p3 <- ggplot(df) + geom_point(aes(x=index,y=sig)) + ylab(TeX("$\\sigma$"))
grid.arrange(p1,p2,p3,ncol=1)
