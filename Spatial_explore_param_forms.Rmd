...
tmpdiff <- tmp %>% filter(q=="q025") %>% mutate(rldiff=(rl075-rl025)) %>% select(cond_site,tau,rldiff)
...
tmap_save(map_param(tmp_est=tmpdiff,method = "rldiff", facet_var = c("cond_site","tau"),title_map = TeX("")),filename=paste0("../Documents/est_all_keef/rldiff_tau.png"),width=12,height=9.5)
