...
tmp <- rbind(tmp_est1 %>% mutate("cond_site"=names(df_sites)[1]),tmp_est2 %>% mutate("cond_site"=names(df_sites)[2]),tmp_est3 %>% mutate("cond_site"=names(df_sites)[3])) %>% mutate(cond_site=factor(cond_site))
map_param(tmp_est = tmp,method = "AGG",facet_var = "cond_site")[[1]]
plot_map_param(tmp_est1=tmp_est1,tmp_est2=tmp_est2,tmp_est3=tmp_est3)[[1]]
```
