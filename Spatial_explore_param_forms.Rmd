...
pa <- tmap_arrange(tm_shape(uk_tmp1) + tm_dots(col="a",style="cont",size=0.3,palette="viridis",title=TeX("$\\alpha$"), breaks=lims) + tm_layout(main.title=threesites[1]),
             tm_shape(uk_tmp2) + tm_dots(col="a",style="cont",size=0.3,palette="viridis",title=TeX("$\\alpha$"), breaks=lims) + tm_layout(main.title=threesites[2]),tm_shape(uk_tmp3) + tm_dots(col="a",style="cont",size=0.3,palette="viridis",title=TeX("$\\alpha$"), breaks=lims) + tm_layout(main.title=threesites[3]),ncol=3)
 if (method=="AGG") {
...
pb <- tmap_arrange(tm_shape(uk_tmp1) + tm_dots(col="b",style="cont",size=0.3,palette="viridis",title=TeX("$\\beta$"), breaks=lims) + tm_layout(main.title=threesites[1]),
             tm_shape(uk_tmp2) + tm_dots(col="b",style="cont",size=0.3,palette="viridis",title=TeX("$\\beta$"), breaks=lims) + tm_layout(main.title=threesites[2]),tm_shape(uk_tmp3) + tm_dots(col="b",style="cont",size=0.3,palette="viridis",title=TeX("$\\beta$"), breaks=lims) + tm_layout(main.title=threesites[3]),ncol=3)
}
...
pmu <- tmap_arrange(tm_shape(uk_tmp1) + tm_dots(col="mu",style="cont",size=0.3,palette="viridis",title=TeX("$\\mu$"), breaks=lims) + tm_layout(main.title=threesites[1]),
             tm_shape(uk_tmp2) + tm_dots(col="mu",style="cont",size=0.3,palette="viridis",title=TeX("$\\mu$"), breaks=lims) + tm_layout(main.title=threesites[2]),tm_shape(uk_tmp3) + tm_dots(col="mu",style="cont",size=0.3,palette="viridis",title=TeX("$\\mu$"), breaks=lims) + tm_layout(main.title=threesites[3]),ncol=3)

sigmax <- 3
lims <- seq(min(as.numeric(rbind(uk_tmp1,uk_tmp2,uk_tmp3)$sig),na.rm = TRUE),sigmax,length.out=6)
psig <- tmap_arrange(tm_shape(uk_tmp1) + tm_dots(col="sig",style="cont",size=0.3,palette="viridis",title=TeX("$\\sigma$"), breaks=lims) + tm_layout(main.title=threesites[1]),
             tm_shape(uk_tmp2) + tm_dots(col="sig",style="cont",size=0.3,palette="viridis",title=TeX("$\\sigma$"), breaks=lims) + tm_layout(main.title=threesites[2]),tm_shape(uk_tmp3) + tm_dots(col="sig",style="cont",size=0.3,palette="viridis",title=TeX("$\\sigma$"), breaks=lims) + tm_layout(main.title=threesites[3]),ncol=3)
if (method=="AGG") {
...
pmuagg <- tmap_arrange(tm_shape(uk_tmp1) + tm_dots(col="mu_agg",style="cont",size=0.3,palette="viridis",title=TeX("$\\mu_{AGG}$"), breaks=lims) + tm_layout(main.title=threesites[1]),
             tm_shape(uk_tmp2) + tm_dots(col="mu_agg",style="cont",size=0.3,palette="viridis",title=TeX("$\\mu_{AGG}$"), breaks=lims) + tm_layout(main.title=threesites[2]),tm_shape(uk_tmp3) + tm_dots(col="mu_agg",style="cont",size=0.3,palette="viridis",title=TeX("$\\mu_{AGG}$"), breaks=lims) + tm_layout(main.title=threesites[3]),ncol=3)

lims <- seq(min(as.numeric(rbind(uk_tmp1,uk_tmp2,uk_tmp3)$sigl),na.rm = TRUE),sigmax,length.out=6)
psigl <- tmap_arrange(tm_shape(uk_tmp1 %>% filter(sigl < sigmax)) + tm_dots(col="sigl",style="cont",size=0.3,palette="viridis",title=TeX("$\\sigma_l$"), breaks=lims) + tm_layout(main.title=threesites[1]),
             tm_shape(uk_tmp2 %>% filter(sigl < sigmax)) + tm_dots(col="sigl",style="cont",size=0.3,palette="viridis",title=TeX("$\\sigma_l$"), breaks=lims) + tm_layout(main.title=threesites[2]),tm_shape(uk_tmp3 %>% filter(sigl < sigmax)) + tm_dots(col="sigl",style="cont",size=0.3,palette="viridis",title=TeX("$\\sigma_l$"), breaks=lims) + tm_layout(main.title=threesites[3]),ncol=3)

lims <- seq(min(as.numeric(rbind(uk_tmp1,uk_tmp2,uk_tmp3)$sigu),na.rm = TRUE),sigmax,length.out=6)
psigu <- tmap_arrange(tm_shape(uk_tmp1 %>% filter(sigu < sigmax)) + tm_dots(col="sigu",style="cont",size=0.3,palette="viridis",title=TeX("$\\sigma_u$"), breaks=lims) + tm_layout(main.title=threesites[1]),
             tm_shape(uk_tmp2 %>% filter(sigu < sigmax)) + tm_dots(col="sigu",style="cont",size=0.3,palette="viridis",title=TeX("$\\sigma_u$"), breaks=lims) + tm_layout(main.title=threesites[2]),tm_shape(uk_tmp3 %>% filter(sigu < sigmax)) + tm_dots(col="sigu",style="cont",size=0.3,palette="viridis",title=TeX("$\\sigma_u$"), breaks=lims) + tm_layout(main.title=threesites[3]),ncol=3)
deltamax <- 5
...
pdeltal <- tmap_arrange(tm_shape(uk_tmp1 %>% filter(deltal < deltamax)) + tm_dots(col="deltal",style="cont",size=0.3,palette="viridis",title=TeX("$\\delta_l$"), breaks=lims) + tm_layout(main.title=threesites[1]),
             tm_shape(uk_tmp2 %>% filter(deltal < deltamax)) + tm_dots(col="deltal",style="cont",size=0.3,palette="viridis",title=TeX("$\\delta_l$"), breaks=lims) + tm_layout(main.title=threesites[2]),tm_shape(uk_tmp3 %>% filter(deltal < deltamax)) + tm_dots(col="deltal",style="cont",size=0.3,palette="viridis",title=TeX("$\\delta_l$"), breaks=lims) + tm_layout(main.title=threesites[3]),ncol=3)

lims <- seq(deltamin,deltamax,length.out=6)
pdeltau <- tmap_arrange(tm_shape(uk_tmp1 %>% filter(deltau < deltamax)) + tm_dots(col="deltau",style="cont",size=0.3,palette="viridis",title=TeX("$\\delta_u$"), breaks=lims) + tm_layout(main.title=threesites[1]),
             tm_shape(uk_tmp2 %>% filter(deltau < deltamax)) + tm_dots(col="deltau",style="cont",size=0.3,palette="viridis",title=TeX("$\\delta_u$"), breaks=lims) + tm_layout(main.title=threesites[2]),tm_shape(uk_tmp3 %>% filter(deltau < deltamax)) + tm_dots(col="deltau",style="cont",size=0.3,palette="viridis",title=TeX("$\\delta_u$"), breaks=lims) + tm_layout(main.title=threesites[3]),ncol=3)
...
```{r}
newite1 <- par_est_ite(df = sims, d1j = d1j, v = 0.9, given = 1, N = 10, show_ite = TRUE)
newite2 <- par_est_ite(df = sims, d1j = d2j, v = 0.9, given = 2, N = 10, show_ite = TRUE)
newite3 <- par_est_ite(df = sims, d1j = d3j, v = 0.9, given = 3, N = 10, show_ite = TRUE)
```
...
```{r}
plot_par_est_ite(newite = newite2)
```
and London.
...
Plot also on a map.
```{r}
plot_map_param(tmp_est1 = newite1[[4]], tmp_est2 = newite2[[4]], tmp_est3 = newite3[[4]],method= "iterative_alpha")
```
...
given <- find_site_index(Inverness)
dij <- as.numeric(st_distance(uk_sf_rot[given,],uk_sf_rot[-given,]))
newite4 <- par_est_ite(df = sims, d1j = dij, v = 0.9, given = given, N = 10, show_ite = TRUE)

given <- find_site_index(Lancaster)
dij <- as.numeric(st_distance(uk_sf_rot[given,],uk_sf_rot[-given,]))
newite5 <- par_est_ite(df = sims, d1j = dij, v = 0.9, given = given, N = 10, show_ite = TRUE)

given <- find_site_index(Newcastle)
dij <- as.numeric(st_distance(uk_sf_rot[given,],uk_sf_rot[-given,]))
newite6 <- par_est_ite(df = sims, d1j = dij, v = 0.9, given = given, N = 10, show_ite = TRUE)
# save into the R object
save(uk,uk_temp_sf,tmp_est1,tmp_est2,tmp_est3,tmp_est1a,tmp_est2a,tmp_est3a,newite1,newite2,newite3,newite4,newite5,newite6,file = "spatialobjects.RData")
```
