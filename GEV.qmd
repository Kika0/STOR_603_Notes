...
df %>% head()
p1 <- df %>% ggplot()  + geom_segment(aes(x = 0, y = 0, xend = 1, yend = 1), color = "#C11432",size=1.2)+ geom_point(aes(x=Empirical,y=Model)) + geom_line(aes(x=Empirical,y=Uup),linetype="dashed", color="#C11432")  + geom_line(aes(x=Empirical,y=Ulow), linetype="dashed", color="#C11432")  + ggtitle("Probability Plot") + xlab("Empirical") + ylab("Model")
...
p2 <- df %>% ggplot()  + 
  ...
  geom_point(aes(y=Data,x=Model)) + geom_line(aes(x=Model,y=GEV_Uup),linetype="dashed", color="#C11432")  + geom_line(aes(x=Model,y=GEV_Ulow), linetype="dashed", color="#C11432")  + ggtitle("Quantile Plot ") + ylab("Empirical") + xlab("Model") 
grid.arrange(p1,p2,ncol=2)
```
