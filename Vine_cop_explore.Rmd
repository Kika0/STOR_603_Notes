...
statisticNOw <- Vuongstat(Zsim1=Zsim1,Zsim2=Zsim2,Nrep=500)
ggplot(data.frame(statisticNOw)) +
...
statisticNOs <- Vuongstat(Zsim1=Zsim1,Zsim2=Zsim2,Nrep=500)
ggplot(data.frame(statisticNOs)) +
...
ggplot(data.frame(statisticO3w)) +
...
ggplot(data.frame(statisticO3control)) +
